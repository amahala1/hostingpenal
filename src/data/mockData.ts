...
export const INITIAL_DNS_RECORDS: DnsRecord[] = [
  { id: 'dns-1', domain: 'sitindia.in', name: '@', type: 'A', value: '168.220.248.86', ttl: 3600, status: 'Active' },
  { id: 'dns-2', domain: 'sitindia.in', name: 'www', type: 'CNAME', value: 'sitindia.in', ttl: 3600, status: 'Active' },
  { id: 'dns-3', domain: 'sitindia.in', name: 'api', type: 'A', value: '168.220.248.86', ttl: 1800, status: 'Active' },
  { id: 'dns-4', domain: 'sitindia.in', name: 'shop', type: 'A', value: '168.220.248.86', ttl: 1800, status: 'Pending' },
  { id: 'dns-5', domain: 'sitindia.in', name: 'staging', type: 'A', value: '168.220.248.86', ttl: 300, status: 'Active' },
  { id: 'dns-6', domain: 'sitindia.in', name: 'mail', type: 'A', value: '168.220.248.86', ttl: 3600, status: 'Active' },
  { id: 'dns-7', domain: 'sitindia.in', name: '@', type: 'MX', value: 'mail.sitindia.in', ttl: 3600, priority: 10, status: 'Active' },
  { id: 'dns-8', domain: 'sitindia.in', name: '@', type: 'TXT', value: 'v=spf1 ip4:168.220.248.86 +a +mx ~all', ttl: 3600, status: 'Active' },
...
export const INITIAL_USER_PROFILE: UserProfile = {
  ...
  loginIp: '168.220.248.86 (server1.sitindia.in)',
};

export const INITIAL_SERVER_USERS = [
  {
    id: 'u-1',
    username: 'sitindia',
    domain: 'sitindia.in',
  ...
  },
  {
    ...
    domain: 'clientcorp.in',
    email: 'contact@clientcorp.in',
    packageName: 'Standard Web (20GB)',
    diskQuotaMB: 20000,
    diskUsedMB: 3420,
    bandwidthQuotaMB: 100000,
    bandwidthUsedMB: 14200,
    dbLimit: 10,
    dbCount: 2,
    emailLimit: 25,
    emailCount: 4,
  ...
  },
  {
    ...
    domain: 'innovatehub.org',
    email: 'team@innovatehub.org',
    packageName: 'Developer Startup (10GB)',
    diskQuotaMB: 10000,
    diskUsedMB: 890,
  ...
  },
  {
    ...
    domain: 'devstage.net',
    email: 'test@devstage.net',
    packageName: 'Basic Sandbox (5GB)',
    diskQuotaMB: 5000,
    diskUsedMB: 420,
