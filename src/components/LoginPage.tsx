  ...
  return (
    ...
    >
        ...
        <div className="lg:col-span-6 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-3 pt-2">
            ...
            <div className="bg-white/80 p-3 rounded-xl border border-purple-200/80 shadow-sm flex items-center gap-2.5">
              ...
              <div>
                <p className="text-xs font-bold text-slate-800">Roundcube Webmail</p>
                <p className="text-[11px] text-slate-500">SSL IMAP/SMTP</p>
              </div>
            </div>
          </div>
        </div>

        {/* Right Side: Exact Sign In Card */}
            ...
            <div>
              ...
              <form onSubmit={handleLoginSubmit} className="space-y-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="ha-input pl-10 text-sm font-semibold text-slate-800"
                      required
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="••••••••••••"
                      className="ha-input pl-10 text-sm"
                      required
                    />
                  </div>
                </div>
                ...
                <button
                  ...
                  type="submit"
                  disabled={isLoading}
                  className="ha-btn ha-btn-purple w-full py-3 text-sm font-bold shadow-md shadow-purple-500/25 flex items-center justify-center gap-2 mt-3"
                >
                  {isLoading ? (
                    <>
      ...
      <footer className="w-full max-w-7xl mx-auto px-6 py-4 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-500 border-t border-slate-200/60 z-10 gap-2">
        <div className="flex items-center gap-2">
          <span>HostAdmin Enterprise Control Panel</span>
          <span>•</span>
          <span className="text-slate-600">Kernel 6.8.0-45-generic</span>
        </div>
        <div className="flex items-center gap-3 text-xs font-medium">
          <span className="text-emerald-600 font-semibold">● System Online</span>
          <span className="text-purple-600 font-semibold">● SSL TLS 1.3 Active</span>
        </div>
      </footer>
    </div>
  );
