          ...
          <form onSubmit={handleLogin} className="p-6 space-y-4">
            ...
            <div className="p-3 bg-blue-50/70 border border-blue-100 rounded-xl space-y-1.5 text-xs text-blue-900">
              <div className="flex items-center gap-2 font-bold">
                ...
                <span>Roundcube v1.7.3 Complete Package • SSH Verified</span>
              </div>
              <div className="text-[11px] font-mono text-slate-600 break-all bg-white p-1.5 rounded border border-blue-100">
                SHA256: 443cde2ea03b840ce4701fe23c273f01e68702f176d282e60248236bbb5f5f85
              </div>
            </div>
            ...
            <div className="space-y-2 pt-1">
              ...
              <a
                href="https://github.com/roundcube/roundcubemail/releases/download/1.7.3/roundcubemail-1.7.3-complete.tar.gz"
                target="_blank"
                rel="noreferrer"
                className="w-full inline-flex items-center justify-center gap-1.5 py-1.5 px-3 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 font-medium text-[11px] border border-slate-200 transition"
              >
                <span>Official Release Archive (v1.7.3 Complete)</span>
                <ExternalLink className="w-3 h-3 text-slate-500" />
              </a>
            </div>
          </form>

          <div className="px-6 py-3 bg-slate-50 border-t border-slate-100 text-center text-[11px] text-slate-500 font-mono">
            Roundcube Webmail v1.7.3 Complete • SHA256: 443cde2e...5f85 Verified ✓
          </div>
        </div>
      </div>
    );
